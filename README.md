...
- If the screen doesn't load anything try running the python script directly: `python3 display_image.py`
...
- crontab -e
- Add `@reboot /physql/detect_shutdown.sh` at bottom of file
...
[Service]
Type=oneshot
ExecStart=/home/pi/shutdown_script.py
